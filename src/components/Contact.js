    ...
    <div className="background">
      <div className="container">
        <div className="screen">
          ...
          <div className="screen-body">
            <div className="screen-body-item left">
              ...
              <div className="app-contact">Mail: siddartha.kodaboina@sjsu.edu</div>
            </div>
        ...
        <div className="credits">
          Connect with me
          <a className="credits-link" href="https://www.linkedin.com/in/siddartha-kodaboina/" target="_blank">
